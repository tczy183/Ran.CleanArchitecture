    ...
    : IModule
{
    ...
    {
        return typeof(IModule).IsAssignableFrom(type) && !type.IsAbstract &&
    ...
    public virtual async Task PostConfigureServicesAsync(IApplicationConfigureServiceContext context)
    {
        PostConfigureServices(context);
        await Task.CompletedTask;
    }

    public virtual void OnPreApplicationInitialization(IApplicationInitializationContext context)
    {
    }

    public virtual async Task OnPreApplicationInitializationAsync(IApplicationInitializationContext context)
    {
    ...
    public virtual async Task OnApplicationInitializationAsync(IApplicationInitializationContext context)
    {
        OnApplicationInitialization(context);
        await Task.CompletedTask;
    }

    public virtual void OnPostApplicationInitialization(IApplicationInitializationContext context)
    {
    }

    public virtual async Task OnPostApplicationInitializationAsync(IApplicationInitializationContext context)
    {
