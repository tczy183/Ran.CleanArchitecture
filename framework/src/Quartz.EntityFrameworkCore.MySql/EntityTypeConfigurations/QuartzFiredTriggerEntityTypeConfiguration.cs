...
public class QuartzFiredTriggerEntityTypeConfiguration(string? prefix)
    : IEntityTypeConfiguration<QuartzFiredTrigger>
{
    public void Configure(EntityTypeBuilder<QuartzFiredTrigger> builder)
    {
        ...
        builder.Property(x => x.JobName).HasColumnName("JOB_NAME").HasColumnType("varchar(200)");

        builder.Property(x => x.JobGroup).HasColumnName("JOB_GROUP").HasColumnType("varchar(200)");

        builder
            .Property(x => x.IsNonConcurrent)
            .HasColumnName("IS_NONCONCURRENT")
            .HasColumnType("tinyint(1)")
            .IsRequired();

        builder
            .Property(x => x.RequestsRecovery)
