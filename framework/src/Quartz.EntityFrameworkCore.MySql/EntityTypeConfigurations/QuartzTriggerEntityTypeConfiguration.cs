...
public class QuartzTriggerEntityTypeConfiguration(string? prefix)
    : IEntityTypeConfiguration<QuartzTrigger>
{
    public void Configure(EntityTypeBuilder<QuartzTrigger> builder)
    {
        ...
        builder
            .Property(x => x.NextFireTime)
            .HasColumnName("NEXT_FIRE_TIME")
            .HasColumnType("bigint(19)");

        builder
            .Property(x => x.PreviousFireTime)
        ...
        builder.Property(x => x.EndTime).HasColumnName("END_TIME").HasColumnType("bigint(19)");
        ...
        builder
            .Property(x => x.MisfireInstruction)
            .HasColumnName("MISFIRE_INSTR")
            .HasColumnType("smallint(2)");

        builder.Property(x => x.JobData).HasColumnName("JOB_DATA").HasColumnType("blob");
        ...
        builder
            .HasIndex(x => new { x.NextFireTime, x.TriggerState })
