...
{
    public static IQuartzModelBuilder UseMySql(
        this IQuartzModelBuilder builder,
        string prefix = "QRTZ_"
    )
    {
        builder.UseEntityTypeConfigurations(context =>
        {
            ...
            context.ModelBuilder.ApplyConfiguration(new QuartzLockEntityTypeConfiguration(prefix));
        });
