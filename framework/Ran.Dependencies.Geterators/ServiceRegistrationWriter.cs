...
public static class ServiceRegistrationWriter
{
    ...
    )
    {
        ...
        codeBuilder.AppendLine("// <auto-generated />").AppendLine("#nullable enable").AppendLine();
        ...
        codeBuilder
            ...
            .AppendLine("/// <summary>")
            .AppendLine(
                $"/// Adds discovered services from {assemblyName ?? string.Empty} to the specified service collection"
            )
            .AppendLine("/// </summary>")
            ...
            .AppendLine(
                "(this global::Microsoft.Extensions.DependencyInjection.IServiceCollection serviceCollection, params string[]? tags)"
            )
            .AppendLine("{")
            .IncrementIndent();
    ...
    )
    {
        ...
        {
            codeBuilder.Append("if (tagSet.Count == 0 || tagSet.Intersect(new[] { ");
            ...
            foreach (var tag in serviceRegistration.Tags)
            {
                ...
                codeBuilder.Append("\"").Append(tag).Append("\"");

                wroteTag = true;
            }

            codeBuilder.AppendLine(" }).Any())").AppendLine("{").IncrementIndent();
        }
        ...
        if (serviceRegistration.Tags.Count > 0)
        {
            codeBuilder.DecrementIndent().AppendLine("}").AppendLine();
        }
    }
    ...
    )
    {
        ...
        {
            codeBuilder.Append(serviceRegistration.ServiceKey).AppendLine(",");
        }
        ...
        else if (serviceRegistration.ImplementationType.HasValue())
        {
            codeBuilder
                ...
                .AppendIf(
                    "global::",
                    !serviceRegistration.ImplementationType.StartsWith("global::")
                )
